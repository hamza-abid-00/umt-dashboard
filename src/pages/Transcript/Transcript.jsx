...
const AcademicTranscript = () => {
  return (
    <div className="max-w-5xl p-6 font-sans h-screen overflow-scroll">
      {/* Header */}
      ...
      <div className="mb-4">
        <p className="text-xs italic">
          ...
          <br />
          This is for student record only. Printout from this Online Transcript
          will not be accepted for any official purpose. Official Transcript
          will be issued by Office of the Controller of Examinations with
      ...
      <div className="flex gap-2">
        <div>
          {/* Fall 2022 */}
          <div className="mb-4">
            <div className="text-center font-semibold bg-gray-100 p-1">
              Fall 2022
            </div>
              ...
              <table className="w-full text-xs border border-dashed-collapse">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="border border-dashed border border-dashed-dashed border border-dashed-dashed border border-dashed-gray-300 p-1 text-left">
                      Course Code
                    </th>
                    <th className="border border-dashed border border-dashed-gray-300 p-1 text-left">
                      Course Title
                    </th>
                    <th className="border border-dashed border border-dashed-gray-300 p-1 text-center">
                      Cr. Hrs
                    </th>
                    <th className="border border-dashed border border-dashed-gray-300 p-1 text-center">
                      Grade
      ...
      <div className="bg-blue-50 p-3">
        ...
        <ol className="text-xs list-decimal pl-5">
          <li className="mb-2">
            ...
            far. This does not indicate that all requisites for the degree have
            been fulfilled.
          </li>
          <li className="mb-2">
            Student shall apply for official Progress Report to Office of the
            Controller of Examinations for sending his/her academic performance
            officially to the institutes / Universities / Employers.
          </li>
        </ol>
      </div>
    </div>
